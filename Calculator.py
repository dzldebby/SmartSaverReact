        ...
        try:
            ...
            with st.expander("ℹ️ How it works", expanded=False):
                ...
                <div class="how-it-works">
                    <h4>Calculate Your Bank Interest in 3 Simple Steps</h4>
                    <ol>
                        <li><strong>Enter your savings amount</strong> - How much you plan to deposit</li>
                        <li><strong>Provide your banking details</strong> - Salary credit, card spend, etc.</li>
                        <li><strong>Calculate and compare</strong> - See which bank offers the best interest rate</li>
                    </ol>
                    <p>The calculator uses the latest interest rates from major Singapore banks to help you maximize your savings.</p>
                </div>
                """, unsafe_allow_html=True)
            
            # Add progress indicator
            progress_step = 1  # Default to step 1
            if 'has_calculated' in st.session_state and st.session_state.has_calculated:
                progress_step = 3  # If calculation done, we're at step 3
            
            st.markdown(f"""
            <div class="progress-indicator">
                <div class="progress-step {'active' if progress_step >= 1 else ''} {'completed' if progress_step > 1 else ''}">
                    <div class="progress-circle">1</div>
                    <div class="progress-label">Enter Amount</div>
                </div>
                <div class="progress-step {'active' if progress_step >= 2 else ''} {'completed' if progress_step > 2 else ''}">
                    <div class="progress-circle">2</div>
                    <div class="progress-label">Banking Details</div>
                </div>
                <div class="progress-step {'active' if progress_step >= 3 else ''}">
            ...
            try:
                with col1:
                    ...
                    <div class="step-container">
                        ...
                        <div class="step-content">
                            <div class="step-title">Enter Your Savings Amount</div>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
                    ...
                    # Basic Requirements - Step 2
                    st.markdown("""
                    <div class="step-container">
                        <div class="step-number">2</div>
                        <div class="step-content">
                            <div class="step-title">Enter Your Banking Details</div>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
                    ...
                    # Add a prominent calculation button at the bottom of col1
                    st.markdown("<br>", unsafe_allow_html=True)  # Add some space
                    calculate_clicked = st.button("Calculate Interest Rates", type="primary", use_container_width=True, key="single_bank_calc")
                ...
                with col2:
                    ...
                    # Create a more descriptive section for the two options - Step 3
                    st.markdown("""
                    <div class="step-container">
                        <div class="step-number">3</div>
                        <div class="step-content">
                            <div class="step-title">Calculate and Compare</div>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
                    ...
                    with tab1:
                        ...
                        # Remove the button from here since we moved it to col1
                        ...
                        if calculate_clicked or st.session_state.get('has_calculated', False):
                            ...
                            with st.spinner("Calculating interest rates..."):
                                ...
                                # Wrap results in a container for visual distinction
                                ...
                                for result in bank_results:
                                    with st.expander(f"{result['bank']} Details", expanded=False):
                                        ...
                                        # Close the results container div
                ...
                if st.session_state.get('has_calculated', False):
                    ...
                    # Add custom CSS for the floating chat button and chat window
                    st.markdown("""
                    <style>
                    ...
                    /* Make sure Streamlit elements inside the chat window are properly styled */
                    .chat-body .stButton button {
                        width: 100%;
                        margin-bottom: 8px;
                    }
                    ...
                    /* Hide the chat input when chat is not open */
                    ...
                    /* Add a pulse animation to make the chat button more noticeable */
                    @keyframes pulse {
                        0% {
                            box-shadow: 0 0 0 0 rgba(0, 104, 201, 0.7);
                        }
                        70% {
                            box-shadow: 0 0 0 10px rgba(0, 104, 201, 0);
                        }
                        100% {
                            box-shadow: 0 0 0 0 rgba(0, 104, 201, 0);
                        }
                    }
                    ...
                    /* Add a badge to indicate the chat feature */
                    .chat-badge {
                        position: absolute;
                        top: -5px;
                        right: -5px;
                    ...
                    # JavaScript to toggle chat window visibility with improved reliability
                    toggle_chat_js = """
                    <script>
                    // Function to create and set up the chat button
                    function createAndSetupChatButton() {
                        console.log('Setting up chat button');
                        
                        // Remove any existing button to avoid duplicates
                        const existingBtn = document.querySelector('.floating-chat-btn');
                        if (existingBtn) {
                            existingBtn.remove();
                        }
                        ...
                        btn.className = 'floating-chat-btn pulse';
                        btn.innerHTML = '💬<span class="chat-badge">AI</span>';
                        ...
                        console.log('Chat button created and appended');
                    }
                    ...
                    function toggleChat() {
                        ...
                        if (chatWindow) {
                            console.log('Toggling chat window visibility');
                        ...
                        if (chatInput) {
                            console.log('Toggling chat input visibility');
                    ...
                    function closeChat() {
                        ...
                        if (chatInput) chatInput.classList.remove('open');
                    }
                    
                    // Set up the chat button when the DOM is loaded
                    document.addEventListener('DOMContentLoaded', function() {
                        console.log('DOM loaded, setting up chat');
                        setTimeout(createAndSetupChatButton, 500);
                        ...
                        document.addEventListener('click', function(e) {
                            ...
                            // If chat is open and click is outside chat window and not on chat button
                    ...
                    window.addEventListener('load', function() {
                        console.log('Window loaded, setting up chat');
                        setTimeout(createAndSetupChatButton, 500);
                        
                        // Additional attempt after a delay
                        setTimeout(createAndSetupChatButton, 2000);
                    });
                    
                    // Create a MutationObserver to detect when Streamlit has finished rendering
                    const observer = new MutationObserver(function(mutations) {
                        if (!document.querySelector('.floating-chat-btn')) {
                            console.log('No chat button found, creating it');
                            createAndSetupChatButton();
                        }
                    });
                    ...
                    // Ensure the chat button exists every 3 seconds (failsafe)
                    setInterval(function() {
                        if (!document.querySelector('.floating-chat-btn')) {
                            console.log('Periodic check: No chat button found, creating it');
                            createAndSetupChatButton();
                        }
                    }, 3000);
                    </script>
                        ...
                        <div class="chat-body" id="chat-container">
                            <div id="chat-placeholder">
                                <p style="text-align: center; color: #666;">
                                    Ask me anything about your interest calculations!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    # Render the floating chat button and window container
                    st.markdown(toggle_chat_js, unsafe_allow_html=True)
                    
                    # Create a hidden container for the chat interface
                    # This will be moved to the chat window using JavaScript
                    chat_placeholder = st.empty()
                    
                    # Create a container for the chat input that will be positioned correctly
                    chat_input_container = st.empty()
                    
                    # Add custom JavaScript to move Streamlit elements into the chat window
                    st.markdown("""
                    <script>
                    // Function to move Streamlit elements into the chat window
                    function moveStreamlitElementsToChat() {
                        console.log('Moving chat elements');
                        
                        // Find the chat placeholder in the Streamlit app
                        const chatPlaceholder = document.querySelector('#chat-placeholder');
                        if (chatPlaceholder) {
                            chatPlaceholder.style.display = 'none';
                        }
                        
                        // Move the chat interface into the chat window
                        const chatContainer = document.querySelector('#chat-container');
                        const streamlitChatElements = document.querySelector('[data-testid="stExpander"]');
                        
                        if (chatContainer && streamlitChatElements) {
                            console.log('Moving expander to chat container');
                            chatContainer.appendChild(streamlitChatElements);
                            
                            // Make the expander always expanded in the chat window
                            const expanderHeader = streamlitChatElements.querySelector('.streamlit-expanderHeader');
                            if (expanderHeader) {
                                expanderHeader.style.display = 'none';
                            }
                            
                            // Make the expander content always visible
                            const expanderContent = streamlitChatElements.querySelector('.streamlit-expanderContent');
                            if (expanderContent) {
                                expanderContent.style.maxHeight = 'none';
                                expanderContent.style.overflow = 'visible';
                            }
                        } else {
                            console.error('Chat container or expander not found', 
                                chatContainer ? 'Container found' : 'Container missing',
                                streamlitChatElements ? 'Expander found' : 'Expander missing');
                        }
                        
                        // Add class to the chat input container for styling
                        const chatInputElement = document.querySelector('[data-testid="stChatInput"]');
                        if (chatInputElement) {
                            console.log('Found chat input, adding container class');
                            // Find the parent that contains the chat input
                            let parent = chatInputElement.parentElement;
                            while (parent && !parent.classList.contains('element-container')) {
                                parent = parent.parentElement;
                            }
                            
                            if (parent) {
                                console.log('Adding chat-input-container class');
                                parent.classList.add('chat-input-container');
                            }
                        } else {
                    ...
                    // Try to move elements when the page loads
                    window.addEventListener('load', function() {
                        setTimeout(moveStreamlitElementsToChat, 1000);
                        setTimeout(moveStreamlitElementsToChat, 2000);
                        setTimeout(moveStreamlitElementsToChat, 3000);
                    });
                    ...
                    # Create the actual chat interface inside an expander (which will be moved to the chat window)
                    with chat_placeholder.expander("Chat", expanded=True):
                        if not OPENAI_AVAILABLE:
                            # Create a more attractive warning message
                            st.markdown("""
                            <div style="background-color: #fff3cd; border-left: 5px solid #ffc107; padding: 1rem; border-radius: 0.25rem; margin-bottom: 1rem;">
                                <h4 style="color: #856404; margin-top: 0;">AI Assistant Unavailable</h4>
                                <p style="margin-bottom: 0;">The AI assistant is currently unavailable because the OpenAI API key is not configured.</p>
                                <p style="font-size: 0.9rem; margin-top: 0.5rem;"><strong>For administrators:</strong> Please set the OPENAI_API_KEY in the Streamlit Cloud secrets or .env file.</p>
                            </div>
                            """, unsafe_allow_html=True)
                        else:
                            ...
                            # Display suggestion chips with better styling
                            st.markdown("<p style='margin-bottom: 0.5rem; font-weight: 500;'>Try asking:</p>", unsafe_allow_html=True)
                            
                            # Create a container for the suggestion buttons
                            suggestion_container = st.container()
                            with suggestion_container:
                                # Calculate how many columns we need (max 3 per row for better spacing)
                                num_suggestions = len(suggestions)
                                num_rows = (num_suggestions + 2) // 3  # Ceiling division
                                ...
                                for row in range(num_rows):
                                    ...
                                    for i in range(3):
                                        ...
                                        if idx < num_suggestions:
                                            ...
                                            button_key = f"suggestion_{idx}_{hash(suggestion)}"
                                            
                                            if cols[i].button(suggestion, key=button_key, use_container_width=True):
                            ...
                            # Add a separator before the chat input
                            st.markdown("<div style='margin: 0.5rem 0;'></div>", unsafe_allow_html=True)
                            
                            # Chat input outside of any container
                            with chat_input_container:
                                # This is now outside of the expander
